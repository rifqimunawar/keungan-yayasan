            ...
            <div class="card-body">
              <form action="{{ route('siswa.update', $data->id) }}" method="post">
                ...
                <div class="form-group col-lg-6">
                  ...
                  <input type="number" name="telp" required placeholder="085xxxx" value="{{ $data->telp }}"
                    class="form-control ">
                </div>
                <div class="form-group col-lg-6">
                ...
                <div class="form-group col-lg-6">
                  ...
                  <select name="tahun_masuk_id" class="form-control select2 ">
                    ...
                    @foreach ($tahun_masuk as $item)
                      <option value="{{ $item->id }}" {{ $data->tahun_masuk_id == $item->id ? 'selected' : '' }}>
                        {{ $item->tahun }}
                      </option>
                    @endforeach
                  </select>
                ...
                <div class="form-group col-lg-6">
                  ...
                  <select name="category_id_kelas_id" id="category_id_kelas_id" class="form-control select2">
                    <option selected disabled>-- pilih --</option>
