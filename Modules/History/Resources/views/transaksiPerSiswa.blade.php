                        ...
                        <div class="card-header">
                            ...
                            <div class="btn-group col-lg-3">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item" href="{{ route('history.transaksiPerSiswa') }}"
                                        onclick="setJenjang('Semua Jenjang')">Semua Jenjang</a>
                                    <a class="dropdown-item" href="{{ route('history.transaksiPerSiswa') }}?search=1"
                                        onclick="setJenjang('SD')">SD</a>
                                    <a class="dropdown-item" href="{{ route('history.transaksiPerSiswa') }}?search=2"
                                        onclick="setJenjang('SMP')">SMP</a>
                                    <a class="dropdown-item" href="{{ route('history.transaksiPerSiswa') }}?search=3"
