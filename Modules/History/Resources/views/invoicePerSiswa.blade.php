        ...
        <div class="row">
          ...
          <table width="100%">
            <tr>
              ...
              <td width="10%" align="center" style="text-align: center;">
                <img alt="logo" src="{{ asset('assets/img/logo-arman.png') }}" height="70px" width="70px"
          ...
          <table border="0" style="width: 100%; border-collapse: collapse; margin-top: 1rem;">
            ...
            <tr style="text-align: center;">
              <td style="font-size: 16px; padding: 5px; text-align: center;">
                <p style="margin: 5px 0 0; font-weight: bold; font-size:18px">REKAP PEMBAYARAN SISWA</p>
              </td>
            </tr>
          </table>
              ...
              <td style="width: 50%; text-align: center; vertical-align: top; padding: 2px;">
                ...
                <table border="1" style="width: 100%; border-collapse: collapse;">
                  <tr>
                    ...
                    <th style="text-align: center; vertical-align: middle;">Petugas TU</th>
          ...
          {{-- <table width="100%" style="margin-top: 1rem;">
            <tr>
              ...
              <td width="50%">
                <table width="100%" border="0" style="text-align: center; border-collapse: collapse;">
                  <tr>
